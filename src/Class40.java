...
final class Class40 {
	...
	final int anInt686;
	final int anInt687;
	static final float[] anIntArray688 = new float[6];
	static final float[] anIntArray689 = new float[6];
	static final float[] anIntArray690 = new float[6];
	static final float[] anIntArray691 = new float[6];
	static final float[] anIntArray692 = new float[6];
