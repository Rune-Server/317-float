...
public final class Model extends Animable {
	...
	private Model(int i) {
		...
		anIntArray1627 = new float[anInt1626];
		anIntArray1628 = new float[anInt1626];
		anIntArray1629 = new float[anInt1626];
		...
		for (int j1 = 0; j1 < anInt1626; j1++) {
			...
			anIntArray1627[j1] = (float) k + i2;
			anIntArray1628[j1] = (float) l + k2;
			anIntArray1629[j1] = (float) i1 + i3;
			k = anIntArray1627[j1];
			l = anIntArray1628[j1];
	...
	public void method464(Model model, boolean flag) {
		...
		if (anIntArray1622.length < anInt1626) {
			anIntArray1622 = new float[anInt1626 + 100];
			anIntArray1623 = new float[anInt1626 + 100];
			anIntArray1624 = new float[anInt1626 + 100];
		}
	...
	private int method465(Model model, int i) {
		int j = -1;
		float k = model.anIntArray1627[i];
		float l = model.anIntArray1628[i];
		float i1 = model.anIntArray1629[i];
		for (int j1 = 0; j1 < anInt1626; j1++) {
	...
	public void method466() {
		...
		for (int i = 0; i < anInt1626; i++) {
			float j = anIntArray1627[i];
			float k = anIntArray1628[i];
			float l = anIntArray1629[i];
		...
		anInt1650 = (float) (Math.sqrt(anInt1650) + 0.99D);
	...
	private void method468() {
		...
		anInt1649 = 0x1869f;
		for (int j = 0; j < anInt1626; j++) {
			float k = anIntArray1627[j];
			float l = anIntArray1628[j];
			float i1 = anIntArray1629[j];
			if (k < anInt1646)
				anInt1646 = k;
			if (k > anInt1647)
				anInt1647 = k;
		...
		anInt1650 = (float) Math.sqrt(anInt1650);
			...
			for (int l1 = 0; l1 < i1; l1++) {
				...
				if (i3 < anIntArrayArray1657.length) {
					...
					for (int j4 = 0; j4 < ai2.length; j4++) {
						...
						int i7 = (l & 0xff) * 8;
						if (i7 != 0) {
							float j7 = modelIntArray1[i7];
							float i8 = modelIntArray2[i7];
							float l8 = anIntArray1628[k5] * j7 + anIntArray1627[k5] * i8;
							anIntArray1628[k5] = anIntArray1628[k5] * i8 - anIntArray1627[k5] * j7;
							anIntArray1627[k5] = l8;
						}
						if (k6 != 0) {
							float k7 = modelIntArray1[k6];
							float j8 = modelIntArray2[k6];
							float i9 = anIntArray1628[k5] * j8 - anIntArray1629[k5] * k7;
							anIntArray1629[k5] = anIntArray1628[k5] * k7 + anIntArray1629[k5] * j8;
							anIntArray1628[k5] = i9;
						}
						if (l6 != 0) {
							float l7 = modelIntArray1[l6];
							float k8 = modelIntArray2[l6];
							float j9 = anIntArray1629[k5] * l7 + anIntArray1627[k5] * k8;
							anIntArray1629[k5] = anIntArray1629[k5] * k8 - anIntArray1627[k5] * l7;
	...
	public void method474(int i) {
		float k = modelIntArray1[i];
		float l = modelIntArray2[i];
		for (int i1 = 0; i1 < anInt1626; i1++) {
			float j1 = anIntArray1628[i1] * l - anIntArray1629[i1] * k;
			anIntArray1629[i1] = anIntArray1628[i1] * k + anIntArray1629[i1] * l;
	...
	public void method479(int i, int j, int k, int l, int i1, boolean flag) {
		...
		for (int i2 = 0; i2 < anInt1630; i2++) {
			...
			float j3 = anIntArray1627[l2] - anIntArray1627[j2];
			float k3 = anIntArray1628[l2] - anIntArray1628[j2];
			float l3 = anIntArray1629[l2] - anIntArray1629[j2];
			float i4 = anIntArray1627[i3] - anIntArray1627[j2];
			float j4 = anIntArray1628[i3] - anIntArray1628[j2];
			float k4 = anIntArray1629[i3] - anIntArray1629[j2];
			float l4 = k3 * k4 - j4 * l3;
			float i5 = l3 * i4 - k4 * j3;
			float j5;
			for (j5 = j3 * j4 - i4 * k3; l4 > 8192 || i5 > 8192 || j5 > 8192 || l4 < -8192 || i5 < -8192 || j5 < -8192; j5 /= 2.0F) {
				l4 /= 2.0F;
				i5 /= 2.0F;
			}
			...
			if (anIntArray1637 == null || (anIntArray1637[i2] & 1) == 0) {
				...
				int l5 = (int) (i + (k * l4 + l * i5 + i1 * j5) / (k1 + k1 / 2));
	...
	public void method482(int j, int k, int l, int i1, float j1, float k1) {
		int i = 0; // was a parameter
		int l1 = Texture.textureInt1;
		int i2 = Texture.textureInt2;
		float j2 = modelIntArray1[i];
		float k2 = modelIntArray2[i];
		float l2 = modelIntArray1[j];
		float i3 = modelIntArray2[j];
		float j3 = modelIntArray1[k];
		float k3 = modelIntArray2[k];
		float l3 = modelIntArray1[l];
		float i4 = modelIntArray2[l];
		float j4 = j1 * l3 + k1 * i4;
		for (int k4 = 0; k4 < anInt1626; k4++) {
			float l4 = anIntArray1627[k4];
			float i5 = anIntArray1628[k4];
			float j5 = anIntArray1629[k4];
			if (k != 0) {
			...
			anIntArray1665[k4] = l1 + (l4 * 512) / j5;
			anIntArray1666[k4] = i2 + (i5 * 512) / j5;
			if (anInt1642 > 0) {
	...
	public void method443(int i, float j, float k, float l, float i1, float j1, float k1, float l1, int i2) {
		float j2 = l1 * i1 - j1 * l;
		float k2 = k1 * j + j2 * k;
		...
		for (int j7 = 0; j7 < anInt1626; j7++) {
			float k7 = anIntArray1627[j7];
			float l7 = anIntArray1628[j7];
			float i8 = anIntArray1629[j7];
			if (i != 0) {
			...
			if (i8 >= 50) {
				anIntArray1665[j7] = l5 + (k7 * 512.0F) / i8;
				anIntArray1666[j7] = j6 + (l7 * 512.0F) / i8;
			} else {
				anIntArray1665[j7] = -5000.0F;
				flag = true;
			}
			if (flag || anInt1642 > 0) {
	...
	private void method483(boolean flag, boolean flag1, int i) {
		...
		for (int k = 0; k < anInt1630; k++)
			if (anIntArray1637 == null || anIntArray1637[k] != -1) {
				...
				float i3 = anIntArray1665[l];
				float l3 = anIntArray1665[k1];
				float k4 = anIntArray1665[j2];
				if (flag && (i3 == -5000.0F || l3 == -5000.0F || k4 == -5000.0F)) {
					aBooleanArray1664[k] = true;
					int j5 = (int) ((anIntArray1667[l] + anIntArray1667[k1] + anIntArray1667[j2]) / 3 + anInt1653);
					...
					if ((i3 - l3) * (anIntArray1666[j2] - anIntArray1666[k1]) - (anIntArray1666[l] - anIntArray1666[k1]) * (k4 - l3) > 0) {
						...
						int k5 = (int) ((anIntArray1667[l] + anIntArray1667[k1] + anIntArray1667[j2]) / 3 + anInt1653);
	...
	private void method484(int i) {
		...
		if (i1 == 1) {
			Texture.method376((int) anIntArray1666[j], (int) anIntArray1666[k], (int) anIntArray1666[l], (int) anIntArray1665[j], (int) anIntArray1665[k], (int) anIntArray1665[l], modelIntArray3[anIntArray1634[i]]);
			return;
		}
		if (i1 == 2) {
		...
		if (i1 == 3) {
			...
			Texture.method378((int) anIntArray1666[j], (int) anIntArray1666[k], (int) anIntArray1666[l], (int) anIntArray1665[j], (int) anIntArray1665[k], (int) anIntArray1665[l], (int) anIntArray1634[i], (int) anIntArray1634[i], (int) anIntArray1634[i], (int) anIntArray1668[i2], (int) anIntArray1668[k2], (int) anIntArray1668[i3], (int) anIntArray1669[i2], (int) anIntArray1669[k2], (int) anIntArray1669[i3], (int) anIntArray1670[i2], (int) anIntArray1670[k2], (int) anIntArray1670[i3], (int) anIntArray1640[i]);
		}
	}
	...
	private void method485(int i) {
		...
		float l1 = anIntArray1670[i1];
		float i2 = anIntArray1670[j1];
		float j2 = anIntArray1670[k1];
		if (l1 >= 50.0F) {
			anIntArray1678[l] = anIntArray1665[i1];
			anIntArray1679[l] = anIntArray1666[i1];
			anIntArray1680[l++] = anIntArray1634[i];
		} else {
			float k2 = anIntArray1668[i1];
		...
		float j4 = anIntArray1678[1];
		float j5 = anIntArray1678[2];
	...
	private boolean method486(int i, int j, float anIntArray16662, float anIntArray16663, float anIntArray16664, float i3, float l3, float k4) {
		if (j < anIntArray16662 && j < anIntArray16663 && j < anIntArray16664)
			return false;
		if (j > anIntArray16662 && j > anIntArray16663 && j > anIntArray16664)
			return false;
		return !(i < i3 && i < l3 && i < k4) && (i <= i3 || i <= l3 || i <= k4);
	}

	public static final Model aModel_1621 = new Model();
	private static float[] anIntArray1622 = new float[2000];
	private static float[] anIntArray1623 = new float[2000];
	private static float[] anIntArray1624 = new float[2000];
	private static int[] anIntArray1625 = new int[2000];
	public int anInt1626;
	public float anIntArray1627[];
	public float anIntArray1628[];
	public float anIntArray1629[];
	...
	public float anInt1646;
	public float anInt1647;
	public float anInt1648;
	public float anInt1649;
	public float anInt1650;
	public float anInt1651;
	...
	private static float[] anIntArray1665 = new float[4096];
	private static float[] anIntArray1666 = new float[4096];
	private static float[] anIntArray1667 = new float[4096];
	private static float[] anIntArray1668 = new float[4096];
	private static float[] anIntArray1669 = new float[4096];
	private static float[] anIntArray1670 = new float[4096];
	...
	public static float modelIntArray1[];
	public static float modelIntArray2[];
